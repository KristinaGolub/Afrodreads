<?php
    switch ($_GET["page"]) {
        case "afro-curls":
            ...
            Кудри можно заплести на каркас, создавая эффект своих естественных кудрей (носятся до 1-1,5 мес), либо можно вплести точечно, как это делается в варианте с дредокудрями (срок носки до 1,5-2 мес).
            Точечное плетение носится чуть дольше, а так же позволяет использовать материал повторно, в отличие от афрокудрей на каркасе.
            Точечный вариант вплетается на полувосьмерку и является абсолютно идентичным принципу работы с любыми де/се дредами и косами, тк в основании кудри будет делаться такой же де/се дред или коса.";
            $path = "afro-curls";
            break;
        case "back-of-the-head":
            ...
            Послужит отличным дополнением к любой повседневной причёске. 
            Подходит для тех, кто хочет экспериментировать, но не готов к кардинальным переменам (либо не позволяет дресс-код), ведь под волосами плетение можно полностью скрыть.";
        ...
        case "extension-on-braids":
            ...
            Отличный способ поэкспериментировать с цветом, не прибегая к окрашиванию. 
            От любого другого наращивания отличается своей бюджетностью, тк наращивание делается синтетикой.
            Срок носки до 1,5 мес.";
            $path = "extension-on-braids";
            break;
        case "natural-dreadlocks":
            $title = "Натуральные дреды";
            $text = "Чаще всего плетутся с помощью начеса и переплетения волос мелким крючком, формируя из них однородную структуру. Могут носиться неограниченный период времени. 
            Важно подплетать их по мере отрастания от корня, а так же поддерживать структуру по длине с помощью своевременных коррекций.
            Натуральные дреды можно как удлинять (натуральными волосами, либо синтетикой), так и укорачивать по мере их отрастания.";
        ...
        case "unweaving":
            ...
            Однако есть ряд нюансов, которые нужно учесть, чтобы не навредить своим волосам.
            В ваше первое расплетение мы все же рекомендуем обратиться к мастеру. Мы покажем, в какой последовательности  выполнять все действия, чтобы при повторном расплетении дома ты все сделал(а) правильно. 
            Имей в виду, что чаще всего самостоятельное расплетение занимает больше времени, нежели в руках мастера. На этот процесс стоит закладывать не меньше времени, чем на заплетение. 
            После расплетения ты так же можешь помыть у нас голову в комплексе со всеми необходимыми уходовыми средствами и даже сделать стрижку.";
            $path = "unweaving";
            break;
        case "weaving":
