<?php
    switch ($_GET["page"]) {
        case "afro-curls":
            $title = "Кудри на каркас и дредокудри";
            $text = "В основе обоих вариантов лежит одинаковый синтетический материал, имеющий разную форму локона (можно так же использовать прямой). 
            </br> Кудри можно заплести на каркас, создавая эффект своих естественных кудрей (носятся до 1-1,5 мес), либо можно вплести точечно, как это делается в варианте с дредокудрями (срок носки до 1,5-2 мес).
            </br> Точечное плетение носится чуть дольше, а так же позволяет использовать материал повторно, в отличие от афрокудрей на каркасе.
            </br> Точечный вариант вплетается на полувосьмерку и является абсолютно идентичным принципу работы с любыми де/се дредами и косами, тк в основании кудри будет делаться такой же де/се дред или коса.";
            $path = "afro-curls";
            break;
        case "back-of-the-head":
            $title = "Дреды и косы на затылок";
            $text = "Являются частичным плетением, так как в этом случае захватывается только затылочная часть головы. На затылок можно заплести как комплект де/се дредов и кос, так и классические афрокосы. 
            </br> Послужит отличным дополнением к любой повседневной причёске. 
            </br> Подходит для тех, кто хочет экспериментировать, но не готов к кардинальным переменам (либо не позволяет дресс-код), ведь под волосами плетение можно полностью скрыть.";
        ...
        case "classic-braids":
            ...
            $text = "Точечные косы с добавлением канекалона. От начала и до конца плетутся непосредственно на клиенте (это их основное отличие от де и се кос). Могут быть любой длины/цвета/толщины/количества. В плетении данной разновидности кос свой волос укрывается материалом, за счёт чего полностью изолируется от всех агрессивных воздействий (активные УФ лучи летом, холодный морозный ветер зимой).";
            $path = "classic-braids";
            break;
        case "de-dreadlocks":
        ...
        case "extension-on-braids":
            $title = " Точечное наращивание на микро-косы";
            $text = "Наращивание на микро-косы из термоволокна, имитирующего натуральный волос. Можно реализовать как полноценное наращивание по всей голове, так и сделать всего один ряд наращивания (например, для загущения общей массы волос или для добавления цветных акцентов).
            </br> Отличный способ поэкспериментировать с цветом, не прибегая к окрашиванию. 
            </br> От любого другого наращивания отличается своей бюджетностью, тк наращивание делается синтетикой.
            </br> Срок носки до 1,5 мес.";
            $path = "extension-on-braids";
            break;
        case "natural-dreadlocks":
            $title = "Натуральные дреды";
            $text = "Чаще всего плетутся с помощью начеса и переплетения волос мелким крючком, формируя из них однородную структуру. </br> Могут носиться неограниченный период времени. 
            </br> Важно подплетать их по мере отрастания от корня, а так же поддерживать структуру по длине с помощью своевременных коррекций.
            </br> Натуральные дреды можно как удлинять (натуральными волосами, либо синтетикой), так и укорачивать по мере их отрастания.";
            $path = "natural-dreadlocks";
            break;
        case "unweaving":
            $title = "Расплетение и уход";
            $text = "В целом, в самостоятельном расплетении  нет ничего сложного, и многие справляются с этим процессом в домашних условиях. 
            </br> Однако есть ряд нюансов, которые нужно учесть, чтобы не навредить своим волосам.
            </br> В ваше первое расплетение мы все же рекомендуем обратиться к мастеру. Мы покажем, в какой последовательности  выполнять все действия, чтобы при повторном расплетении дома ты все сделал(а) правильно. 
            </br> Имей в виду, что чаще всего самостоятельное расплетение занимает больше времени, нежели в руках мастера. На этот процесс стоит закладывать не меньше времени, чем на заплетение. 
            </br> После расплетения ты так же можешь помыть у нас голову в комплексе со всеми необходимыми уходовыми средствами и даже сделать стрижку.";
            $path = "unweaving";
            break;
        case "weaving":
